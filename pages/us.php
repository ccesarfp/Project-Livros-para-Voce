...
<body>
    ...
    <main id="main">
        <div>
            ...
            <h4>&nbsp;Bom, na verdade, não existe nós, mas sim, eu.<br>&nbsp;Sou um estudante de Engenharia de Software que para concluir uma matéria da faculdade, decidiu desenvolver um site para facilitar o acesso para livros que caíram em Domínio Público.</h4>
        </div>
    </main>
    <footer>
